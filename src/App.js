        ...
        <Box>
          {selectedId ? (
            <MovieDetails
              ...
              onAddWatchedMovie={handleAddMovies}
              watched={watched}
            />
          ) : (
            <>
              ...
              <WatchedMoviesList
                watched={watched}
                onDeleteWatchedMovies={handleDeleteMovie}
              />
            </>
          )}
        </Box>
...
function MovieDetails({
  ...
  function AddMovie() {
    const newMovie = {
      ...
      userRating,
      countingRatingRef: countRef.current,
    };
...
function WatchedMovies({ movie, onDeleteWatchedMovies }) {
  return (
    <li>
      <img src={movie.poster} alt={movie.title} />
      <h3>{movie.title}</h3>
